...
const (
	...
	SyncJobTypeInventory    SyncJobType = "inventory" // full discovery + availability import
)
...
type SyncJob struct {
	...
	ProductsDiscovered int            `gorm:"default:0" json:"products_discovered"`
	SlotsStored        int            `gorm:"default:0" json:"slots_stored"`
	ProductsSkipped    int            `gorm:"default:0" json:"products_skipped"`
	WorkerCount        int            `gorm:"default:40" json:"worker_count"`
