...
func main() {
	...
	headoutGroup := router.Group("/api/v1/headout")
	{
		...
		headoutGroup.GET("/v2/products/:productId/svg", headoutHandler.GetVenueMap)
		headoutGroup.GET("/v2/products/:productId/seatmap", headoutHandler.GetVenueSeatmap)
		headoutGroup.POST("/v2/seatmap/products/:productId/variants/:variantId/validate", headoutHandler.ValidateSeatmap)
