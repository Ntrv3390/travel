  ...
  return (
    <section className="min-h-screen bg-[radial-gradient(circle_at_10%_-14%,rgba(37,99,235,0.14),transparent_36%),radial-gradient(circle_at_88%_-8%,rgba(14,165,233,0.08),transparent_34%),#f8fafc] text-slate-900">
      <div className="mx-auto w-full max-w-[1280px] px-3 pb-[5.6rem] pt-3 md:px-4 md:pb-6 md:pt-4">
        ...
        <div className="grid grid-cols-1 justify-start gap-4 md:grid-cols-[minmax(0,1fr)_320px] md:gap-6 lg:grid-cols-[minmax(0,680px)_360px] lg:gap-8 xl:grid-cols-[minmax(0,720px)_380px]">
          <motion.div
            className="relative z-0 grid min-w-0 max-w-full content-start gap-4 lg:max-w-[680px] xl:max-w-[720px]"
            initial="hidden"
            whileInView="show"
          ...
          >
            <motion.article id="included" className="hidden md:block" variants={sectionMotion} transition={{ duration: 0.45 }}>
            ...
            <motion.article id="about" className="hidden md:block" variants={sectionMotion} transition={{ duration: 0.45 }}>
              <Card className={sectionCardClass}>
                <CardContent className="p-0">
                  <h2 className="font-[Sora,Inter,Manrope,sans-serif] text-xl font-extrabold leading-tight tracking-tight text-slate-900">
            ...
            <div className="grid gap-3 md:hidden">
              <details className="rounded-xl border border-slate-200 bg-white px-3 py-1 shadow-[0_10px_30px_rgba(15,23,42,0.06)]" open>
                <summary className="cursor-pointer py-3 text-sm font-bold">What is included</summary>
              ...
              <details className="rounded-xl border border-slate-200 bg-white px-3 py-1 shadow-[0_10px_30px_rgba(15,23,42,0.06)]">
                <summary className="cursor-pointer py-3 text-sm font-bold">Description</summary>
                <p className="mb-2 text-sm leading-relaxed text-slate-500">
                  Premium guided entry with strong operational support, bilingual commentary, and scenic photo moments.
                </p>
              </details>
            </div>

            <motion.article id="reviews" variants={sectionMotion} transition={{ duration: 0.45 }}>
              <Card className={sectionCardClass}>
                <CardContent className="p-0">
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-6 lg:grid-cols-12">
            ...
            <motion.article id="combinations" variants={sectionMotion} transition={{ duration: 0.45 }}>
              <Card className={sectionCardClass}>
                <CardContent className="p-0">
                  <h2 className="font-[Sora,Inter,Manrope,sans-serif] text-xl font-extrabold leading-tight tracking-tight text-slate-900">
            ...
            <motion.article id="more-ways" variants={sectionMotion} transition={{ duration: 0.45 }}>
              <Card className={sectionCardClass}>
                <CardContent className="p-0">
                  ...
                  <div className="mt-4 flex w-full snap-x snap-mandatory gap-3 overflow-x-auto overflow-y-hidden pb-1 [&::-webkit-scrollbar]:hidden" ref={moreWaysRailRef}>
          ...
          <motion.aside
            className="relative z-0 grid content-start gap-4"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.45, delay: 0.08 }}
          >
            <Card className="w-full rounded-2xl border border-slate-300/90 bg-[radial-gradient(circle_at_88%_0%,rgba(37,99,235,0.09),transparent_35%),linear-gradient(180deg,#ffffff_0%,#f8fbff_100%)] p-4 shadow-[0_26px_46px_rgba(15,23,42,0.16)] md:sticky md:top-[9.95rem]">
              <CardContent className="p-0">
