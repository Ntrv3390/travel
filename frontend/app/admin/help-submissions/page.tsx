...
import { Search, ChevronDown, ChevronLeft, ChevronRight, HelpCircle, Mail } from "lucide-react";
...
export default function AdminHelpSubmissionsPage() {
  ...
  return (
    ...
    >
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900">Help Submissions</h1>
